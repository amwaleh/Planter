...
Read `PLAN.md` and `.github/copilot-instructions.md` before making product or architecture changes.

The highest-priority constraints are:

- Never fabricate environmental, groundwater, soil, forecast, crop, or livestock data.
